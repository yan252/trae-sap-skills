...
### Financial BAPI
- **Finance BAPI**: `references/finance-bapi.md` - Financial module BAPI functions and usage scenarios
...
└── references/                     # Detailed reference files (28 files)
    ...
    ├── finance-bapi.md            # Financial module BAPI functions and usage scenarios
    ... and 24 more specialized references
```
...
- **Reference Files**: 29
- **Total Lines**: ~26,000 across all reference files
