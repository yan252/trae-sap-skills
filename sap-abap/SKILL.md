...
This skill includes 29 comprehensive reference files covering all aspects of ABAP development:
...
- `references/finance-bapi.md` - Financial module BAPI functions and usage scenarios
- ... and 17 more specialized references
