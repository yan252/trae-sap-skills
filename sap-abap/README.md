...
- **Financial BAPI**: Financial module BAPI functions and usage scenarios
...
└── references/                     # Detailed reference files (29 files)
    ...
    ├── finance-bapi.md             # Financial module BAPI functions
    ...
    ├── skill-reference-guide.md    # Complete guide to all reference files
...
- **Reference Files**: 29
- **Source Coverage**: 94% (32 of 34 source files)
